  ...
  return (
    <>
      <div className="pt-30 px-10 xsm:w-full md:w-1/2 xsm:ml-0 md:ml-[25%] text-center">
        ...
        <p>
          This Privacy Policy describes how rolexdurablewatches.com (the "Site"
          or "we") collects, uses, and discloses your Personal Information when
          you visit or make a purchase from the Site.
        </p>
        <h3 className="text-xl font-bold mt-10">Contact</h3>
        <p>
          ...
          details provided below: 701 Sansom St, Philadelphia, PA 19106, United States
        </p>
        ...
        <ul className="list-disc">
          <li>
            <p className="font-bold mt-2">Device Information</p>
          ...
          <li>
            <p className="font-bold mt-2">Order information</p>
            <ul className="list-disc px-3">
              <li>
                <span className="font-bold">Purpose of collection:</span> to
                provide products or services to you to fulfill our contract, to
        ...
        <h3 className="text-xl font-bold mt-10">Minors</h3>

        <p>
          The Site is not intended for individuals under the age of 19. We do
        ...
        <p>
          ...
          above. For example: We use Shopify to power our online store. We may
        ...
        <h3 className="text-3xl font-bold mb-5">Behavioural Advertising</h3>
        <p>
          ...
          with other Shopify merchants and who may also be interested in what we
          have to offer. We also share information about your use of the Site,
          your purchases, and the email address associated with your purchases
          with Shopify Audiences, through which other Shopify merchants may make
          offers you may be interested in. For more information about how
          ...
          https://optout.aboutads.info/. rights.
        </p>
        <h3 className="text-3xl font-bold mb-5 mt-7">
        ...
        <h3 className="text-3xl font-bold mb-5 mt-7">Cookies</h3>
        <p>
          We use your personal Information to provide our services to you, which
          includes: offering products for sale, processing payments, shipping
          and fulfillment of your order, and keeping you up to date on new
        ...
        <h3 className="text-3xl font-bold mb-5 mt-7">Complaints</h3>
        <p>
          ...
          authority, or our supervisory authority here: [Add contact information
          or website for the data protection authority in your jurisdiction. For
          example: https://ico.org.uk/make-a-complaint/] Last updated: [Date]
        </p>
      </div>
      <Faqs />
    </>
